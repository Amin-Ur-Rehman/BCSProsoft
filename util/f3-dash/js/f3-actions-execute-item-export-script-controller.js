...
(function() {
    ...
    angular.module("f3UC")
        .controller("ExecuteItemExportScriptController", ExecuteItemExportScriptController);
    ...
    function ExecuteItemExportScriptController(f3Store, $http, $timeout) {
        console.log('ExecuteItemExportScriptController');
        ...
        viewModel.loadGrid = function(options) {
            ...
            var apiUrl = location.href.replace(location.hash, '') + '&method=getItemExportScriptDeploymentInstances';
            $http.get(apiUrl)
        ...
        this.execute = function () {
            ...
            var apiUrl = location.href.replace(location.hash, '') + '&method=executeItemExportScript';
            $http.get(apiUrl)
                .success(function(response) {
