...
(function() {
    ...
    angular.module("f3UC")
        .controller("ExecuteItemImportScriptController", ExecuteItemImportScriptController);
    ...
    function ExecuteItemImportScriptController(f3Store, $http, $timeout) {
        console.log('ExecuteItemImportScriptController');
        ...
        viewModel.loadGrid = function(options) {
            ...
            var apiUrl = location.href.replace(location.hash, '') + '&method=getItemImportScriptDeploymentInstances';
            $http.get(apiUrl)
        ...
        this.execute = function () {
            ...
            var apiUrl = location.href.replace(location.hash, '') + '&method=executeItemImportScript';
            $http.get(apiUrl)
                .success(function(response) {
