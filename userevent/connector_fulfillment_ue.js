        ...
        syncFulfillmentMagento: function (sessionID, magentoSO) {
            ...
            if (!responseMagento.status) {
                ...
                ErrorLogNotification.logAndNotify({
                    ...
                    action: "Item Fulfillment Export from NetSuite to Magento",
                ...
                if (havingErrorInTrackingNumberExport) {
                    ErrorLogNotification.logAndNotify({
                        ...
                        recordId: nlapiGetRecordId(),
                        recordDetail: "NetSuite # " + nlapiLookupField(nlapiGetRecordType(), nlapiGetRecordId(), "tranid"),
                        action: "Export Tracking Information from NetSuite to Magento",
                ...
                if (type.toString() === 'create') {
                    ...
                    if (Utility.isBlankOrNull(sessionID)) {
                        ...
                        ErrorLogNotification.logAndNotify({
                            ...
                            recordId: nlapiGetRecordId(),
                            recordDetail: "NetSuite # " + nlapiLookupField(nlapiGetRecordType(), nlapiGetRecordId(), "tranid"),
                            action: "Export Item Fulfillment from NetSuite to Magento",
                            message: "Unable to fetch Session Id from Magento",
                            messageDetails: "Look into script logs or Magento logs",
                            status: F3Message.Status.ERROR,
                            externalSystemText: ConnectorConstants.CurrentStore.systemDisplayName,
                            system: "NetSuite"
                        });
